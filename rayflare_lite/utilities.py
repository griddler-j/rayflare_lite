...
def make_absorption_function(result, structure, options):
    ...
    from rayflare_lite.transfer_matrix_method import tmm_structure
    from rayflare_lite.ray_tracing import rt_structure
    from rayflare_lite.structure import Structure
